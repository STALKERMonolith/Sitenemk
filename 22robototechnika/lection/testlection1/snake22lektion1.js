...
const texts1 = [
    "Наука про створення програмного забезпечення для роботів  ",
    "2Середина XX століття ",
    "Джордж Девол",
    "Розробка нових технологій  ",
    "Підмога в домашніх обов'язках  "
];
...
const texts2 = [
    ...
    " Стародавній світ",
    "Леонардо да Вінчі",
    "Спрощення рутинних завдань, таких як прибирання",
    "Проведення точних хірургічних операцій"
];

const texts3 = [
    "Що таке робототехніка?",
    "Який історичний період пов'язаний із створенням перших механічних автоматів?",
    "Хто з цих діячів створював прототипи механічних людей у Ренесанс?",
    "Яка роль роботів у побуті?",
    "Яке з цих завдань найчастіше виконують роботи в медичній сфері"
];
