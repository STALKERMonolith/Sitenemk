...
const texts1 = [
    "Галузь, яка досліджує автоматизацію космічних місій",
    "РУР ",
    "Виконання промислових завдань",
    "Оптичні сенсори",
    "Зниження кількості пасажирських місць",
    "Вивчення історії робототехніки",
    "Сонячні панелі",
    "Промисловий маніпулятор",
    "Промислові роботи ",
    "Зменшення кількості роботів на виробництві  "
];

const texts2 = [
    "Міждисциплінарна галузь, що охоплює розробку, проєктування та використання роботів",
    "Unimate",
    "Взаємодія з людьми і підтримка соціальних потреб",
    "Ультразвукові сенсори",
    "Зменшення потреби у людському втручанні",
    "Розробка алгоритмів для керування роботами  ",
    "Акумулятори ",
    "Хірургічний робот",
    "Домашні роботи",
...
const texts3 = [
    ...
    "Який робот вважається першим промисловим роботом?",
    "Що є основним призначенням соціальних роботів?",
    "Який тип сенсора використовується для вимірювання відстані? ",
    "Що є головною перевагою автономних транспортних засобів? ",
    "Що є ключовою складовою програмування роботів?  ",
    "Яке джерело живлення найбільш поширене для мобільних роботів? ",
    "Який робот допомагає виконувати точні хірургічні операції? ",
    "Як називаються роботи, які допомагають людям у побуті? ",
    "Яка основна тенденція в робототехніці майбутнього?"
];
